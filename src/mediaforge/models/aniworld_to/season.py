...
from ...config import MEDIAFORGE_SEASON_PATTERN, GLOBAL_SESSION, logger
...
class AniworldSeason:
    ...
    Attributes (Example):
        ...
        season_number:  1
        episode_count:  12
        episodes:       [<mediaforge.models.aniworld_to.episode.AniworldEpisode object at 0x10b2023c0>, [...]]
        _html:          "<!doctype html>[...]"
    ...
    def is_valid_aniworld_season_url(url):
        ...
        return bool(MEDIAFORGE_SEASON_PATTERN.match(url))
